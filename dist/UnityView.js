...
var UnityView = /** @class */ (function (_super) {
    ...
    UnityView.prototype.render = function () {
        ...
        return (React.createElement(react_native_1.View, __assign({}, props),
            React.createElement(NativeUnityView, { style: { position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, backgroundColor: 'blue', width: '100%', height: '100%' }, onUnityMessage: props.onUnityMessage, onMessage: props.onMessage }),
            props.children));
    };
    return UnityView;
}(react_1.Component));
...
*/
NativeUnityView = (0, react_native_1.requireNativeComponent)('RNUnityViewManager');
