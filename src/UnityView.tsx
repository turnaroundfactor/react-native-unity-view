...
class UnityView extends Component<UnityViewProps> {
    ...
    render() {
        ...
        return (
            <View {...props}>
            <NativeUnityView
                style={{ position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, backgroundColor: 'blue', width: '100%', height: '100%' }}
...
NativeUnityView = requireNativeComponent('RNUnityViewManager')
